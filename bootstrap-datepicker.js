...
(function ($, undefined) {
	...
	function Datepicker() {
		...
		this._defaults = { // Global defaults for all the date picker instances
			...
			leftArrowClasses: 'icon-circle-arrow-left"', // Default value of next months button classes
			rightArrowClasses: 'icon-circle-arrow-right"', // Default value of previous months button classes
